            ...
            {links.map((link) => (
              ...
              >
                <div className="double-bezel-inner p-5 flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-accent/5 flex items-center justify-center shrink-0 transition-all duration-500 group-hover:bg-accent/10">
                    <link.icon size={16} className="text-accent" weight="duotone" />
                  </div>
                  <div className="flex-1">
                    <h4 className="font-heading text-sm font-semibold text-text">{link.title}</h4>
                    <span className="text-text-muted text-[13px]">{link.info}</span>
                  </div>
                  <ArrowUpRight size={14} className="text-text-muted transition-all duration-500 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" weight="bold" />
                </div>
              </a>
            ))}
          </div>
